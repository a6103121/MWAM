...
## The process of embedding MWAM on MMANet is as follows:
 ...
 - Instantiate this class in the existing model in line 435 of ```./models/surf_baseline.py```
...
Two new functions are defined in lines 473-541.
```
 - Integrating these computational processes into the forward derivation process, as detailed in lines 438–447 of ```./models/surf_baseline.py```.
 - Add weights from different modalities to the output of the model's forward inference process in line 472 of ```./models/surf_baseline.py```.
